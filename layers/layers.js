...
var format_SIGNALISATION_6 = new ol.format.GeoJSON();
var features_SIGNALISATION_6 = format_SIGNALISATION_6.readFeatures(json_SIGNALISATION_6, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_SIGNALISATION_6 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_SIGNALISATION_6.addFeatures(features_SIGNALISATION_6);
var lyr_SIGNALISATION_6 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_SIGNALISATION_6, 
                style: style_SIGNALISATION_6,
                interactive: true,
                title: '<img src="styles/legend/SIGNALISATION_6.png" /> SIGNALISATION'
            });

lyr_OpenStreetMap_0.setVisible(true);lyr_COMMUNESTRAVERSEES_1.setVisible(false);lyr_EPCITRAVERSEES_2.setVisible(false);lyr_BOUCLEDECYCLOTOURISMEn13_3.setVisible(false);lyr_INDREAVELO_4.setVisible(true);lyr_STJACQUESAVELO_5.setVisible(true);lyr_SIGNALISATION_6.setVisible(true);
var layersList = [lyr_OpenStreetMap_0,lyr_COMMUNESTRAVERSEES_1,lyr_EPCITRAVERSEES_2,lyr_BOUCLEDECYCLOTOURISMEn13_3,lyr_INDREAVELO_4,lyr_STJACQUESAVELO_5,lyr_SIGNALISATION_6];
...
lyr_SIGNALISATION_6.set('fieldAliases', {'IDENT': 'IDENT', });
...
lyr_SIGNALISATION_6.set('fieldImages', {'IDENT': 'TextEdit', });
...
lyr_SIGNALISATION_6.set('fieldLabels', {'IDENT': 'header label', });
lyr_SIGNALISATION_6.on('precompose', function(evt) {
